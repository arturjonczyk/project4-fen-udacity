...
var pizzaElementGenerator = function(i) {
	...
	pizzaContainer.classList.add("randomPizzaContainer", "col-md-4", "col-sm-6");
...
function updatePositions() {
	...
	requestAnimationFrame(function() {
		for (var i = 0; i < numPizzas; i++) {
			...
			// change position of pizza element baisde on 3 values,
			// x, y, z - x and y will change, z is 0 and will stay like that.
			// here we use translate3D, becouse we want that the job is done
			// throu GPU.
...
var movingPizzasGroup = document.querySelector("#movingPizzas1"), // div that grouping all the moving pizzas
	...
	// and update generated pizzas positions on the screen.
	document.addEventListener('DOMContentLoaded', function() {
		for (var i = 0; i < numPizzas; i++) {
			var elem = document.createElement('img');
			elem.className = 'mover';
			elem.src = "images/pizza-small.png";
			movingPizzasGroup.appendChild(elem);
		}
